...
import kr.co.hs.cleanarchitecturesample.view.BookInfoGridItemView
import kr.co.hs.cleanarchitecturesample.view.BookInfoLinearItemView
...
class ViewTest {
    ...
    @Test
    fun Book_정보_뷰_테스트_for_linear() = runTest(timeout = Duration.INFINITE) {
    ...
    @Test
    fun Book_정보_뷰_테스트_for_grid() = runTest(timeout = Duration.INFINITE) {
        activityScenario.onActivity {
            val viewGroup = it.window.decorView.findViewById<ViewGroup>(android.R.id.content)
