...
class BookInfoGridItemViewTest {
    @get:Rule
    ...
    fun do_Test() = runTest(timeout = Duration.INFINITE) {
        activityScenario.onActivity {
            ...
            viewGroup.addView(BookInfoGridItemView(it))
        }

        Espresso.onView(ViewMatchers.withId(kr.co.hs.cleanarchitecturesample.R.id.tv_title))
            .check(ViewAssertions.matches(ViewMatchers.withText("")))
        Espresso.onView(ViewMatchers.withId(kr.co.hs.cleanarchitecturesample.R.id.tv_sub_title))
            .check(ViewAssertions.matches(ViewMatchers.withText("")))
        Espresso.onView(ViewMatchers.withId(kr.co.hs.cleanarchitecturesample.R.id.tv_price))
            .check(ViewAssertions.matches(ViewMatchers.withText("")))
        ...
        activityScenario.onActivity {
            ...
            viewGroup.addView(BookInfoGridItemView(it).apply { set(bookSummaryEntity) })
        }
        ...
        activityScenario.onActivity {
            val viewGroup = it.window.decorView.findViewById<ViewGroup>(android.R.id.content)
            viewGroup.removeAllViews()
            viewGroup.addView(BookInfoGridItemView(it).apply { set(entity) })
        }
